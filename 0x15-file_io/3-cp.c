...
/**
* main - the main function main
* @argc: variable representing thee total number of arguments
...
/**
* error_98 - function that checks error 98
* @f0: the variable rep the value to check
...
/**
* error_99 - function that checks error 99
* @f0:the variable rep value to check
* @buffer: the buffer pointer
* @argv: argument variable
*/
...
/**
* error_100 - function that checks error 100
* @f0: the variable rep value to check
* @buffer: the buffer pointer
*/
